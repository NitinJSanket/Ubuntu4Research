...
# For Cuda 10.0
printf "${YELLOW} Go to https://developer.nvidia.com/rdp/form/cudnn-download-survey and download CudNN Developer v7.6 for CUDA 10.0 tar file ${NC} \n "
read -p "Press <ENTER> to continue"
tar -zxvf ~/Downloads/cudnn-10.0-linux-x64-v7.6.0.64.tgz
